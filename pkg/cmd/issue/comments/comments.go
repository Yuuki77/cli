...
func NewCmdComments(f *cmdutil.Factory, runF func(*CreateOptions) error) *cobra.Command {
	opts := &CreateOptions{
		IO:         f.IOStreams,
	...
	cmd := &cobra.Command{
		Use:   "comments {<number> | <url>}",
		Short: "Create comments in the issue",
		Example: heredoc.Doc(`
...
func createComments(opts *CreateOptions) error {
	// fmt.Println("create a comments")
	...
	if action == prShared.PreviewAction {
		...
		err := api.CommentCreate(apiClient, repo, params)
		if err != nil {
			return err
		}
